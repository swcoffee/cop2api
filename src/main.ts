...
import { isMcpFastPath } from "./lib/fast-path"

// Fast path: `copilot-api mcp` starts the MCP bridge without loading citty
// or the gateway modules, keeping MCP client startup fast.
